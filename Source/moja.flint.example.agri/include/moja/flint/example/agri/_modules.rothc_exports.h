...
#ifndef AGRI_EXPORTS_INCLUDED
#define AGRI_EXPORTS_INCLUDED

//
// The following block is the standard way of creating macros which make exporting
// from a DLL simpler. All files within this DLL are compiled with the ROTHC_EXPORTS
// symbol defined on the command line. this symbol should not be defined on any project
// that uses this DLL. This way any other project whose source files include this file see
// ROTHC_API functions as being imported from a DLL, wheras this DLL sees symbols
// defined with this macro as being exported.
//

#if defined(_WIN32) && defined(MOJA_DLL)
#if defined(AGRI_EXPORTS)
#define AGRI_API __declspec(dllexport)
#else
#define AGRI_API __declspec(dllimport)
#endif
#endif

#if !defined(AGRI_API)
#if !defined(AGRI_NO_GCC_API_ATTRIBUTE) && defined (__GNUC__) && (__GNUC__ >= 4)
...
//
// Automatically link moja.flint.example.rothc library.
//
#if defined(_MSC_VER)
#if !defined(MOJA_NO_AUTOMATIC_LIBS) && !defined(ROTHC_EXPORTS)
#pragma comment(lib, "moja.flint.example.rothc" MOJA_LIB_SUFFIX)
#endif
#endif

#endif // ROTHC_EXPORTS_INCLUDED
