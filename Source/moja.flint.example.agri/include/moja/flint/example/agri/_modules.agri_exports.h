...
// from a DLL simpler. All files within this DLL are compiled with the AGRI_EXPORTS
// symbol defined on the command line. this symbol should not be defined on any project
// that uses this DLL. This way any other project whose source files include this file see
// AGRI_API functions as being imported from a DLL, wheras this DLL sees symbols
...
//
// Automatically link moja.flint.example.agri library.
//
#if defined(_MSC_VER)
#if !defined(MOJA_NO_AUTOMATIC_LIBS) && !defined(AGRI_EXPORTS)
#pragma comment(lib, "moja.flint.example.agri" MOJA_LIB_SUFFIX)
#endif
#endif

#endif // AGRI_EXPORTS_INCLUDED
