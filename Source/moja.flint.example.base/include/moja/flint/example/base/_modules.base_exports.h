...
#ifndef BASE_EXPORTS_INCLUDED
#define BASE_EXPORTS_INCLUDED
...
#if !defined(BASE_API)
#if !defined(BASE_NO_GCC_API_ATTRIBUTE) && defined (__GNUC__) && (__GNUC__ >= 4)
...
//
// Automatically link moja.flint.example.base library.
//
#if defined(_MSC_VER)
#if !defined(MOJA_NO_AUTOMATIC_LIBS) && !defined(BASE_EXPORTS)
#pragma comment(lib, "moja.flint.example.base" MOJA_LIB_SUFFIX)
#endif
#endif

#endif // BASE_EXPORTS_INCLUDED
